...
LOHNART_MAPPING = [
    # LA 1000 Stundenlohn: direkt aus Spalte P "Arbeitszeit" (z.B. "85,48 h"),
    # weil Excel-Spalte D "Grundlohn" nur Excel-interne Anzeige ist und
    # nicht zur Buchung verwendet wird.
    {"excel_col": "P", "excel_header": "Arbeitszeit",       "lohnart": "1000", "feld": "stunden", "label": "Stundenlohn (Arbeitszeit direkt)"},

    # Zuschlag-Lohnarten: EUR aus Excel → Stunden = EUR / (Stundensatz × Prozent)
